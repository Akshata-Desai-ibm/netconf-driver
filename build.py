...
PKG_ROOT = 'netconfdriver'
PKG_INFO = 'pkg_info.json'
DIST_DIR = 'dist'
WHL_FORMAT = 'netconfdriver-{version}-py3-none-any.whl'

DOCS_FORMAT = 'netconfdriver-{version}-docs'
DOCS_DIR = 'docs'

DOCKER_WHLS_DIR = 'whls'
DOCKER_PATH = 'docker'
DOCKER_IMG_NAME = 'netconf-driver'
DOCKER_REGISTRY = 'icr.io/cp4na-drivers'

HELM_CHART_PATH = os.path.join('helm', 'netconf-driver')
HELM_CHART_NAME = 'netconf-driver'
HELM_CHART_NAME_FORMAT = 'netconf-driver-{0}.tgz'
